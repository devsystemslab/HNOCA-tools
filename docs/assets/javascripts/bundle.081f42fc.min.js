...
(() => {
    ...
    var io = (e, t) => {
        ...
        if (e != null && Dt)
            for (var o of Dt(e))
                t.indexOf(o) < 0 && no.call(e, o) && (r[o] = e[o]);
        return r;
    };
    var yr = (e, t) => () => (
    ...
    var ao = (e, t, r) =>
        new Promise((o, n) => {
            var i = (p) => {
                ...
                s = (p) =>
                    p.done ? o(p.value) : Promise.resolve(p.value).then(i, a);
    ...
    var co = yr((Er, so) => {
        (function (e, t) {
            ...
            function e(r) {
                ...
                function J(H) {
                    (H.target.nodeName &&
                        H.target.nodeName.toLowerCase() === "html") ||
                        ((o = !1), ie());
                }
                        ...
                        686: function (o, n, i) {
                            ...
                            function A(V) {
                                ...
                                (O.style.fontSize = "12pt"),
                                    ...
                                    (O.style[_ ? "right" : "left"] = "-9999px");
                                var j =
                                    window.pageYOffset ||
                                    document.documentElement.scrollTop;
                                return (
                                    (O.style.top = "".concat(j, "px")),
                            ...
                            function vr(V, _) {
                                var O = "data-clipboard-".concat(V);
                                if (_.hasAttribute(O)) return _.getAttribute(O);
                            }
                            var Ri = (function (V) {
                                    Ci(O, V);
                                    var _ = Hi(O);
  ...
  `)
    ...
    var bt = {
        ...
        requestAnimationFrame: function () {
            ...
            var r = bt.delegate;
            return (
                (r == null ? void 0 : r.requestAnimationFrame) ||
        ...
        cancelAnimationFrame: function () {
            ...
            var r = bt.delegate;
            return (
                (r == null ? void 0 : r.cancelAnimationFrame) ||
        ...
        return (
            ...
            (t.prototype._trimBuffer = function () {
                var r = this,
                    ...
                    s = (a ? 1 : 2) * o;
                if (
                    (o < 1 / 0 && s < i.length && i.splice(0, i.length - s), !a)
                ) {
                    for (
                        var p = n.now(), c = 0, l = 1;
                        l < i.length && i[l] <= p;
    ...
    var vt = (function (e) {
        ...
        return (
            ...
            (t.prototype.requestAsyncId = function (r, o, n) {
                return (
                    n === void 0 && (n = 0),
                    At.setInterval(r.flush.bind(r, this), n)
                );
            }),
            ...
            (t.prototype.requestAsyncId = function (r, o, n) {
                return (
                    ...
                    n !== null && n > 0
                        ...
                        : (r.actions.push(this),
                          r._scheduled ||
                              (r._scheduled = bt.requestAnimationFrame(
                                  function () {
    ...
    function Xt(e) {
        return (
            ...
            k(e == null ? void 0 : e[Symbol.asyncIterator])
        );
    }
    function Zt(e) {
    ...
    function S() {
        ...
        var r = He(e),
            o = Bt(e, 1 / 0),
            n = e;
        return n.length ? (n.length === 1 ? W(n[0]) : yt(o)(ue(n, r))) : M;
    }
    var Ke = new F(he);
        ...
        return y(function (t, r) {
            ...
            (o = t.subscribe(
                T(r, void 0, void 0, function (a) {
                    (i = W(e(a, ve(e)(t)))),
                        o
                            ? (o.unsubscribe(), (o = null), i.subscribe(r))
                            : (n = !0);
                }),
            )),
                ...
                S(
                    ...
                    d(t, "error").pipe(
                        b(() =>
                            $r(
                                () =>
                                    new ReferenceError(`Invalid script: ${e}`),
                            ),
                        ),
                    ),
                ).pipe(
    ...
    var Go = new g(),
        ya = C(() =>
            ...
            b((e) => S(Ke, I(e)).pipe(L(() => e.disconnect()))),
            B(1),
        );
    function ce(e) {
                ...
                typeof (t == null ? void 0 : t.progress$) != "undefined" &&
                    (o.addEventListener("progress", (n) => {
                        ...
                        if (n.lengthComputable)
                            ...
                            let a =
                                (i = o.getResponseHeader("Content-Length")) !=
                                null
                                    ? i
                                    : 0;
    ...
    function gn(e) {
        if (!G("announce.dismiss") || !e.childElementCount) return M;
        if (!e.hidden) {
            let t = P(".md-typeset", e);
            __md_hash(t.innerHTML) === __md_get("__announce") &&
                (e.hidden = !0);
        }
        return C(() => {
            let t = new g();
    ...
    function Tn(e) {
        let t = e[0].score,
            ...
            o = ye(),
            n = r.findIndex(
                (l) => !`${new URL(l.location, o.base)}`.includes("#"),
            ),
            [i] = r.splice(n, 1),
    ...
    function Cn(e, t) {
        return C(() => {
            let r = An(e);
            return typeof r != "undefined" ? fr(r, e, t) : M;
        });
    }
    var Hn = Vt(Yr());
    var Fa = 0;
        ...
        let { matches: r } = matchMedia("(hover)"),
            o = C(() => {
                ...
                if (
                    ...
                    let l = wn(c.id);
                    c.insertBefore(l, e),
                        G("content.tooltips") && a.push(lt(l, { viewport$ }));
                }
                ...
                if (s instanceof HTMLElement) {
                    ...
                    if (
                        typeof c != "undefined" &&
                        (s.classList.contains("annotate") ||
                            G("content.code.annotate"))
                    ) {
                        let l = fr(c, e, t);
                        a.push(
                            ge(s).pipe(
    ...
    function Va() {
        return typeof mermaid == "undefined" || mermaid instanceof Element
            ? wt("https://unpkg.com/mermaid@10/dist/mermaid.min.js")
            : I(void 0);
    }
    function In(e) {
        return (
    ...
    function Na(e) {
        ...
        return S(
            ...e.map((r) =>
                d(r, "change").pipe(m(() => P(`label[for="${r.id}"]`))),
            ),
        ).pipe(
            Q(P(`label[for="${t.id}"]`)),
            m((r) => ({ active: r })),
    ...
    function Ka({ viewport$: e }) {
        if (!G("header.autohide")) return I(!1);
        let t = e.pipe(
                m(({ offset: { y: n } }) => n),
                Ye(2, 1),
                m(([n, i]) => [n < i, i]),
            ...
            r = z([e, t]).pipe(
                v(([{ offset: n }, [, i]]) => Math.abs(i - n.y) > 100),
                m(([, [n]]) => n),
                K(),
            ),
            o = Ve("search");
    ...
    function zn(e, { header$: t, main$: r }) {
        return C(() => {
            let o = new g(),
                n = o.pipe(X(), ne(!0));
            o.pipe(Z("active"), We(t)).subscribe(
                ([{ active: a }, { hidden: s }]) => {
        ...
        return z([o, n, t]).pipe(
            m(
                ([
                    ...
                    (c = Math.max(
                        0,
                        c - Math.max(0, a - p, i) - Math.max(0, c + p - s),
                    )),
    ...
    function Ba(e) {
        let t = __md_get("__palette") || {
                index: e.findIndex(
                    (o) =>
                        matchMedia(o.getAttribute("data-md-color-media"))
                            .matches,
                ),
            },
            ...
            return (
                i.subscribe((a) => {
                    if (
                        ...
                        (a.color.scheme = p.getAttribute(
                            "data-md-color-scheme",
                        )),
                            (a.color.primary = p.getAttribute(
                                "data-md-color-primary",
                            )),
                            (a.color.accent = p.getAttribute(
    ...
    function Xa(e, t) {
        if (!(e.target instanceof Element)) return M;
        let r = e.target.closest("a");
        if (r === null) return M;
        if (r.target || e.metaKey || e.ctrlKey) return M;
        let o = new URL(r.href);
        return (
            (o.search = o.hash = ""),
            t.has(`${o}`) ? (e.preventDefault(), I(new URL(r.href))) : M
        );
    }
    function Jn(e) {
        let t = new Map();
        ...
        return je($("script", r)).pipe(
            b((o) => {
                ...
                if (o.src) {
                    ...
                    return (n.textContent = o.textContent), o.replaceWith(n), M;
            }),
            X(),
            ne(document),
        );
    ...
    function Zn({ location$: e, viewport$: t, progress$: r }) {
        ...
        let s = e.pipe(
            Z("pathname"),
            b((p) => ln(p, { progress$: r }).pipe(ve(() => (pt(p, !0), M)))),
            b(Xn),
            b(Za),
            pe(),
        );
        return (
            S(
                ...
                history.state !== null || !p.hash
                    ? window.scrollTo(
                          0,
                          (l = (c = history.state) == null ? void 0 : c.y) !=
                              null
                              ? l
                              : 0,
                      )
    ...
    function ii({ document$: e }) {
        let t = ye(),
            r = Ne(new URL("../versions.json", t.base)).pipe(ve(() => M)),
            o = r.pipe(
                m((n) => {
                    let [, i] = t.base.match(/([^/]+)\/?$/);
                    return (
        ...
        r
                        ...
                        b(([i, a]) => {
                            if (i.target instanceof Element) {
                                ...
                                if (s && !s.target && n.has(s.href)) {
                                    let p = s.href;
                                    return !i.target.closest(".md-version") &&
                                        n.get(p) === a
                                        ? M
            ...
            e.pipe(b(() => o)).subscribe((n) => {
                ...
                if (i === null) {
                    i = !0;
                    let s =
                        ((a = t.version) == null ? void 0 : a.default) ||
                        "latest";
                    Array.isArray(s) || (s = [s]);
                    e: for (let p of s)
    ...
    function si(e, { worker$: t, query$: r }) {
        let o = new g(),
            n = tn(e.parentElement).pipe(v(Boolean)),
            i = e.parentElement,
    ...
    function pi(e, { worker$: t, keyboard$: r }) {
        ...
        return (
            o
                ...
                .subscribe(
                    (s) => (e.innerHTML = s.join("").replace(/\s/g, "&nbsp;")),
                ),
        ...
        try {
            ...
            d(e, "click")
                .pipe(
                    v(
                        ({ target: p }) =>
                            p instanceof Element && !!p.closest("a"),
                    ),
                )
                        ...
                        return I(
                            [...o].reduce((c, [l, f]) => {
                                for (
                                    ;
                                    p.length &&
                                    o.get(p[p.length - 1]).tagName >= f.tagName;
                                )
                                    p.pop();
                                let u = f.offsetTop;
    ...
    function xi({ document$: e, viewport$: t }) {
        e
            .pipe(
                ...
                v((r) => r.offsetWidth < r.scrollWidth),
                oe((r) => {
                    let o = r.innerText,
                        n = r.closest("a") || r;
                    return (
    ...
    function Ei({ document$: e }) {
        e.pipe(
            ...
            r === 0
                ? (t.scrollTop = 1)
                : r + t.offsetHeight === t.scrollHeight &&
                  (t.scrollTop = r - 1);
        });
    }
    ...
    Zr.pipe(v(({ mode: e }) => e === "global")).subscribe((e) => {
        switch (e.type) {
            case "p":
            case ",":
    ...
    var rt = Nn(Se("header"), { viewport$: Oe }),
        Ft = ot.pipe(
            m(() => Se("main")),
            b((e) => Qn(e, { viewport$: Oe, header$: rt })),
            B(1),
        ),
        ds = S(
        ...
        hs = C(() =>
            S(
                ...
                ...ae("content").map((e) =>
                    G("search.highlight")
                        ? mi(e, { index$: Mi, location$: jt })
                        : M,
                ),
                ...ae("header-title").map((e) =>
                    qn(e, { viewport$: Oe, header$: rt }),
                ),
                ...ae("sidebar").map((e) =>
                    e.getAttribute("data-md-type") === "navigation"
                        ? Nr(Si, () =>
                              Jr(e, { viewport$: Oe, header$: rt, main$: Ft }),
                          )
                        : Nr(hr, () =>
                              Jr(e, { viewport$: Oe, header$: rt, main$: Ft }),
                          ),
