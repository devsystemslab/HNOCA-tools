!(function (e, r) {
    ...
    return function (e) {
        ...
        (e.ar = function () {
            ...
            (e.ar.trimmer = e.trimmerSupport.generateTrimmer(
                e.ar.wordCharacters,
            )),
            ...
            (e.ar.stemmer = (function () {
                ...
                return (
                    ...
                    (e.removeSuf432 = function () {
                        ...
                        if (e.word.length >= 6) {
                            var t = new RegExp(
                                "(" + e.suf.suf4.split(" ").join("|") + ")$",
                            );
                            e.word = e.word.replace(t, "");
                        }
                        if (e.word == r && e.word.length >= 5) {
                            var c = new RegExp(
                                "(" + e.suf.suf3.split(" ").join("|") + ")$",
                            );
                            e.word = e.word.replace(c, "");
                        }
                        if (e.word == r && e.word.length >= 4) {
                            var l = new RegExp(
                                "(" + e.suf.suf2.split(" ").join("|") + ")$",
                            );
                            e.word = e.word.replace(l, "");
                        }
                        return r != e.word && (e.sufRemoved = !0), !1;
                    ...
                    (e.wordCheck = function () {
                        ...
                        for (
                            t = 0;
                            6 == e.word.length && !e.result && t < l.length;
                        )
                            l[t](), t++;
                        var n = [
                            e.checkPattern53,
                        ...
                        for (
                            t = 0;
                            5 == e.word.length && !e.result && t < n.length;
                        )
                            n[t](), t++;
                        var o = [
                            e.checkPattern43,
                        ...
                        for (
                            t = 0;
                            4 == e.word.length && !e.result && t < o.length;
                        )
                            o[t](), t++;
                        return !0;
                    }),
