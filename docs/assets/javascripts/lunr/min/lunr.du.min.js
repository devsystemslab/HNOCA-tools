...
!(function (e, r) {
    ...
    return function (e) {
        ...
        console.warn(
            ...
            (e.du.trimmer = e.trimmerSupport.generateTrimmer(
                e.du.wordCharacters,
            )),
                    ...
                    n = new (function () {
                        function e() {
                            ...
                            for (
                                ...
                                if (
                                    ((r = C.cursor), C.in_grouping(q, 97, 232))
                                ) {
                                    if (
                                        ((i = C.cursor),
                                        (C.bra = i),
                        ...
                        function n(e) {
                            return (
                                (C.cursor = e), e >= C.limit || (C.cursor++, !1)
                            );
                        }
                        function o() {
                            (_ = C.limit),
                        ...
                        function d() {
                            var e,
                                ...
                                s = C.limit - C.cursor;
                            if (
                                ((C.ket = C.cursor), (e = C.find_among_b(h, 5)))
                            )
