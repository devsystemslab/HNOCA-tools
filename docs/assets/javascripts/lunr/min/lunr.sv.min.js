        ...
        (e.sv = function () {
            this.pipeline.reset(),
                ...
                this.searchPipeline &&
                    ...
                    this.searchPipeline.add(e.sv.stemmer));
        }),
            (e.sv.wordCharacters =
                "A-Za-zªºÀ-ÖØ-öø-ʸˠ-ˤᴀ-ᴥᴬ-ᵜᵢ-ᵥᵫ-ᵷᵹ-ᶾḀ-ỿⁱⁿₐ-ₜKÅℲⅎⅠ-ↈⱠ-ⱿꜢ-ꞇꞋ-ꞭꞰ-ꞷꟷ-ꟿꬰ-ꭚꭜ-ꭤﬀ-ﬆＡ-Ｚａ-ｚ"),
            (e.sv.trimmer = e.trimmerSupport.generateTrimmer(
                e.sv.wordCharacters,
            )),
                        ...
                        function e() {
                            ...
                            if (((o = w.limit), 0 <= r || r <= w.limit)) {
                                for (a = r; ; ) {
                                    if (
                                        ((e = w.cursor),
                                        w.in_grouping(l, 97, 246))
                                    ) {
                                        w.cursor = e;
                                        break;
                                    }
                                    if (((w.cursor = e), w.cursor >= w.limit))
                                        return;
                                    w.cursor++;
                                }
