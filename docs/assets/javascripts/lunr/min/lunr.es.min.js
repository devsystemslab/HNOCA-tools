...
!(function (e, s) {
    ...
    return function (e) {
        ...
        (e.es = function () {
            ...
            (e.es.trimmer = e.trimmerSupport.generateTrimmer(
                e.es.wordCharacters,
            )),
                ...
                var s = e.stemmerSupport.Among,
                    ...
                    n = new (function () {
                        ...
                        function h() {
                            var e, s;
                            if (
                                ((A.ket = A.cursor), (e = A.find_among_b(z, 8)))
                            )
                                switch (((A.bra = A.cursor), e)) {
                                    case 1:
                                        u() && A.slice_del();
