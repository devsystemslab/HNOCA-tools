...
!(function (e, r) {
    ...
    return function (e) {
        ...
        (e.de = function () {
            ...
            (e.de.trimmer = e.trimmerSupport.generateTrimmer(
                e.de.wordCharacters,
            )),
                                ...
                                for (n = v.cursor; ; ) {
                                    if (
                                        ...
                                        if (
                                            ...
                                            break;
                                        if (((v.cursor = s), e("y", "Y", i)))
                                            break;
                                    }
                                    if (i >= v.limit)
                                        return void (v.cursor = n);
                                    v.cursor = i + 1;
                                }
                        }
                        function s() {
                            ...
                            if (
                                ...
                                switch (e) {
                                    ...
                                    case 2:
                                        ...
                                        break;
                                    case 3:
                                        v.in_grouping_b(g, 98, 116) &&
                                            v.slice_del();
                                }
                            if (
                                ((v.cursor = v.limit - s),
                                (v.ket = v.cursor),
                                (e = v.find_among_b(f, 4)) &&
                                    ((v.bra = v.cursor), c()))
                            )
                                switch (e) {
                                    case 1:
