    ...
    var B = (t, e, r) =>
        new Promise((n, i) => {
            var s = (u) => {
                ...
                a = (u) =>
                    u.done ? n(u.value) : Promise.resolve(u.value).then(s, o);
...
`,
                    ...
                    return (
                        e.forEach(function (n) {
                            ...
                            if (i) r.add(i);
                                ...
                                throw new Error(
                                    "Cannot load unregistered function: " + n,
                                );
                        }),
                        r
                    );
            ...
            (t.Vector = function (e) {
                ...
                (t.Vector.prototype.magnitude = function () {
                    ...
                    for (
                        var e = 0, r = this.elements.length, n = 1;
                        n < r;
                        n += 2
                    ) {
                ...
                (t.Index.prototype.query = function (e) {
                    ...
                    for (var u = 0; u < r.clauses.length; u++) {
                        var c = r.clauses[u],
                            ...
                            g = t.Set.empty;
                        c.usePipeline
                            ? (f = this.pipeline.runString(c.term, {
                                  fields: c.fields,
                              }))
                            : (f = [c.term]);
            ...
            (t.Builder = function () {
                ...
                (t.MatchData.prototype.combine = function (e) {
                    for (
                        var r = Object.keys(e.metadata), n = 0;
                        n < r.length;
                        n++
                    ) {
                        var i = r[n],
                        ...
                        for (var o = 0; o < s.length; o++) {
                            ...
                            for (var c = 0; c < u.length; c++) {
                                ...
                                this.metadata[i][a][f] == null
                                    ? (this.metadata[i][a][f] =
                                          e.metadata[i][a][f])
                                    : (this.metadata[i][a][f] = this.metadata[
                                          i
                                      ][a][f].concat(e.metadata[i][a][f]));
                            }
                        }
                    }
                }),
                (t.MatchData.prototype.add = function (e, r, n) {
                    ...
                    for (var i = Object.keys(n), s = 0; s < i.length; s++) {
                        ...
                        o in this.metadata[e][r]
                            ? (this.metadata[e][r][o] = this.metadata[e][r][
                                  o
                              ].concat(n[o]))
                ...
                switch (i) {
                    ...
                    case "TERM":
                        W(s, lunr.tokenizer.separator, (...u) => {
                            r.push(
                                [e.slice(0, o), s.slice(...u), e.slice(a)].join(
                                    "",
                                ),
                            );
                        });
    ...
    function Ie(t) {
        return B(this, null, function* () {
            ...
            t.lang.length > 1 && r.push(`${e}/min/lunr.multi.min.js`),
                r.length &&
                    (yield importScripts(
                        `${e}/min/lunr.stemmer.support.min.js`,
                        ...r,
                    ));
        });
    }
